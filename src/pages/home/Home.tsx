...
function Home() {
  ...
  const {usuario} = useContext(AuthContext);
    ...
    return (
        <>
        <div className="cor-fundo flex justify-center z-[-1]">
...
<section className="mt-8 z-[-1]">
  <div className="flex my-4 px-20 z-[-1]">
    <div className="text-justify mt-10 mr-20 z-[-1]">
    ...
    <div className="justify-end w-full relative z-[-1]">
